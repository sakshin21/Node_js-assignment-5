...
let transporter=nodemailer.createTransport({
    ...
    secure:false,
    auth:{
        user:"sakshinarawade2001@gmail.com",
        pass:"ccmxyqthtcmpmakq"
    }
});
...
//database connection
mongoose.connect("mongodb+srv://sakshi:sakshi@cluster0.qk6mabg.mongodb.net/mongoass")
...
.isLength({ min: 8, max: 10 })],(req, res) => {
    ...
    userModel.create({ email:email,username: uname, password: hash,image:req.file.filename,status:0 })
        .then(data => {
            let mailOptions={
                from:'sakshinarawade2001@gmail.com',
                to:email,
